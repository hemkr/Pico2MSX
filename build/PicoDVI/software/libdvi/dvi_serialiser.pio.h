...
#define dvi_serialiser_pio_version 1

static const uint16_t dvi_serialiser_program_instructions[] = {
            //     .wrap_target
    0x78a1, //  0: out    pc, 1           side 2
    0x74a1, //  1: out    pc, 1           side 1
            //     .wrap
};
...
static const struct pio_program dvi_serialiser_program = {
    ...
    .length = 2,
    .origin = 0,
    .pio_version = dvi_serialiser_pio_version,
...
#define dvi_serialiser_debug_pio_version 1
...
static const struct pio_program dvi_serialiser_debug_program = {
    ...
    .length = 12,
    .origin = -1,
    .pio_version = dvi_serialiser_debug_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
