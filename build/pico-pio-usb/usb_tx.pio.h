...
#define usb_tx_dpdm_pio_version 1
...
static const struct pio_program usb_tx_dpdm_program = {
    ...
    .length = 5,
    .origin = -1,
    .pio_version = usb_tx_dpdm_pio_version,
...
#define usb_tx_pre_dpdm_pio_version 1
...
static const struct pio_program usb_tx_pre_dpdm_program = {
    ...
    .length = 5,
    .origin = -1,
    .pio_version = usb_tx_pre_dpdm_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define usb_tx_dmdp_pio_version 1
...
static const struct pio_program usb_tx_dmdp_program = {
    ...
    .length = 5,
    .origin = -1,
    .pio_version = usb_tx_dmdp_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define usb_tx_pre_dmdp_pio_version 1
...
static const struct pio_program usb_tx_pre_dmdp_program = {
    ...
    .length = 5,
    .origin = -1,
    .pio_version = usb_tx_pre_dmdp_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
