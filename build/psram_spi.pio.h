...
#define spi_psram_fudge_wrap_target 0
#define spi_psram_fudge_wrap 9
#define spi_psram_fudge_pio_version 1

static const uint16_t spi_psram_fudge_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static const struct pio_program spi_psram_fudge_program = {
    .instructions = spi_psram_fudge_program_instructions,
    .length = 10,
    .origin = -1,
    .pio_version = spi_psram_fudge_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config spi_psram_fudge_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + spi_psram_fudge_wrap_target, offset + spi_psram_fudge_wrap);
...
#define spi_psram_wrap_target 0
#define spi_psram_wrap 8
#define spi_psram_pio_version 1

static const uint16_t spi_psram_program_instructions[] = {
            //     .wrap_target
    0x6828, //  0: out    x, 8            side 1
    0x6848, //  1: out    y, 8            side 1
    0x0843, //  2: jmp    x--, 3          side 1
...
#if !PICO_NO_HARDWARE
static const struct pio_program spi_psram_program = {
    .instructions = spi_psram_program_instructions,
    .length = 9,
    .origin = -1,
    .pio_version = spi_psram_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config spi_psram_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + spi_psram_wrap_target, offset + spi_psram_wrap);
    sm_config_set_sideset(&c, 2, false, false);
    return c;
}
...
#define qspi_psram_pio_version 1
...
static const struct pio_program qspi_psram_program = {
    ...
    .length = 11,
    .origin = -1,
    .pio_version = qspi_psram_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
